...
import com.waz.zclient.views.SearchResultUserRowView

class UserViewHolder(val view: View, val showContactInfo: Boolean) extends RecyclerView.ViewHolder(view) {
